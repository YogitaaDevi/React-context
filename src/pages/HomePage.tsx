  ...
  return (
    <>
      <div className="relative overflow-hidden bg bg-no-repeat text-center chef-image">
        <img src={chef} className="chef-image w-full" />
        <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed"
          ...
          <div className="flex h-full mt-24 justify-center">
            <div className="text-white w-150 h-24 flex flex-col gap-6">
              ...
              <div>
                <Button className="text-black h-12 w-32 rounded hover:bg-slate-200" name="View items" onClick={()=> navigate("/home/product")} variant="PRIMARY"/>
              </div>
            </div>
          </div>
        </div>
