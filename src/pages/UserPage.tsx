      ...
      <div className="w-150 h-96 flex">
        <div className="w-full flex flex-col items-center justify-center gap-4 font-bold">
          ...
          <div className="flex gap-10 mt-3">
            <Button className="bg-slate-700" name="View Orders" onClick={() => navigate("/home/user/order")} size="lg"/>
            <Button className="bg-slate-700" name="View Profile" onClick={() => navigate("/home/user/profile")} size="lg" />
          </div>
        </div>
      </div>
      <Button className="bg-red-500 mt-5 focus:ring-red-700" name="Back" onClick={() => navigate("/home/product")} variant="SECONDARY"/>
    </div>
  )
}
